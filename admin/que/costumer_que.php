<?php
 ...
 // ADD PRODUCT
	if(ISSET($_POST['savecostumer'])){
			...
			{
			$sql = "INSERT INTO `costumer` (`z_idnum`,`z_lastname`,`z_firstname`,`z_mi`,`z_age`,`z_contact`,`z_address`,`z_email`,`z_postal`, `z_job`, `z_salary`, `z_status`, `z_pass`) VALUES ('$idnum','$lastname','$firstname','$mi','$age','$contact','$address', '$email', '$postal', '$job', '$salary', '$status', '$pass')";
			$conn->exec($sql);
			$conn = null;
