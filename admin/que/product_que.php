...
if(ISSET($_POST['editproduct'])){
		try{
			...
			$sql = "UPDATE `product` SET `p_code` = '$code', `p_name` = '$name', `p_category` = '$category', `p_description` = '$description', `p_value` = '$value', `p_quantity` = '$quantity', `p_supname` = '$supname' WHERE `p_id` = '$id'";
			$conn->exec($sql);
