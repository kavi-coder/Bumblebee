...
<div class="content">
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <a href="stock_add.php"><button type="button"  class="btn btn-primary " style="font-size: 12px;">Register Product</button></a>
                   <a href="stock_manage.php"><button type="button"  class="btn btn-success " style="font-size: 12px;">Manage Item ( In/Out )</button></a>
	...
	?>
			        ...
			        <td><?php echo "LKR ".  $row['p_value']?></td>
