...
<div class="content">
    ...
    for($i=0; $row = $result->fetch(); $i++){
			        ...
			        <td><?php echo "LKR ".  $row['r_price']?></td>
			        <td><?php echo "LKR ".  $row['r_total']?></td>
			        <td><?php echo "LKR ".  $row['r_tax']?></td>
			        <td><?php echo "LKR ". $row['r_montly']?></td>
			        <td><?php echo "LKR ".  $row['r_downpayment']?></td>
