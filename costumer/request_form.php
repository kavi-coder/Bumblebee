...
<script type="text/javascript">
 ...
 <div class="form-group">
  ...
  <?php 
require ("que/db.php");
$stmt = $conn->prepare("SELECT * from costumer where z_idnum = '{$_SESSION["username"]}' ");
$stmt->execute();
...
<option selected value="<?php echo $id; ?>" required><?php echo $a .", ". $b ." ".$c .". ". " [ The Salary of This Customer is : ". $salary ."]"; ?> </option>
