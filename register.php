...
<div class="container"style="margin: 8% 18% ; width: 900px">
 ...
 <form action="admin/que/costumer_que.php" method="POST">
   ...
   <div class="row">
    ...
    <div class="col">
      ...
      <div class="modal-footer">
         <a href="supplier.php"> <button type="button" class="btn btn-secondary" style="font-size: 12px;">Close</button></a>
        <button type="submit" class="btn btn-primary" name="savecostumer" style="font-size: 12px;">Save</button>
      </div>
      </form>
